      ...
      <div class="carousel-inner border-radius-lg h-100">
        ...
        >
          ...
          >
            ...
            <h5 class="text-white mb-1">Get started from Checking code</h5>
            <p>
        ...
        >
          ...
          >
            ...
            <h5 class="text-white mb-1">Faster to exam your team works</h5>
            <p>
        ...
        >
          ...
          >
            ...
            <h5 class="text-white mb-1">Share with us your current works with!</h5>
            <p>
